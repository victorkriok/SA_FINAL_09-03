-- Active: 1772983474410@@localhost@3306@estoquesa
...
ALTER TABLE Perfil ADD descricao VARCHAR(255) NOT NULL;
ALTER TABLE Usuario ADD salt VARCHAR(255) NOT NULL;
ALTER TABLE Usuario
DROP COLUMN salt;
INSERT INTO Perfil (nome, descricao) VALUES
('Admin', 'Acesso total ao sistema'),
('SupervisorProducao', 'Gerencia ordens de produção'),
('TecnicoManutencao', 'Gerencia manutenção de equipamentos'),
('Almoxarife', 'Gerencia estoque');

INSERT INTO Usuario (nome, login, senhaHash, salt, perfilId)
VALUES ('Admin', 'admin', '123', 'abc', 1);

SELECT * FROM Usuario WHERE login = 'admin';

UPDATE usuario
SET senhaHash = '$2a$11$9poz4QMdyqLaLd.2UPn9D.nNLmx3yJKHWpopspEtgnn4tjpBYEK/e'
WHERE login = 'admin';